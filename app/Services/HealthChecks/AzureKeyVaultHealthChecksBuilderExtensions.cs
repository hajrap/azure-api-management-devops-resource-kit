using Azure.Core;
using com.dxc.lxp.Services.HealthChecks;
...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class AzureKeyVaultHealthChecksBuilderExtensions
    {
        ...
        {
            AzureKeyVaultOptions options = new AzureKeyVaultOptions();
            ...
            return builder.Add(new HealthCheckRegistration(
               name ?? KEYVAULT_NAME,
               sp => new com.dxc.lxp.Services.HealthChecks.AzureKeyVaultHealthCheck(keyVaultServiceUri, credential, options),
               failureStatus,
               tags,
               timeout));
        }
